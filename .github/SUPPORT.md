# Getting help with `GeneralNormalizer`

Thank you for using `GeneralNormalizer`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/GeneralNormalizer`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/t/GeneralNormalizer),
...
[search issues and pull requests](https://github.com/fgualdr/GeneralNormalizer/issues)
